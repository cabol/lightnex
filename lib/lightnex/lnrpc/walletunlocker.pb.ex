defmodule Lightnex.LNRPC.WalletUnlocker.GenSeedRequest do
...
defmodule Lightnex.LNRPC.WalletUnlocker.GenSeedResponse do
  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
...
defmodule Lightnex.LNRPC.WalletUnlocker.InitWalletRequest do
  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
  ...
  field :channel_backups, 5,
    type: Lightnex.LNRPC.Lightning.ChanBackupSnapshot,
  ...
  field :watch_only, 9, type: Lightnex.LNRPC.WalletUnlocker.WatchOnly, json_name: "watchOnly"
  field :macaroon_root_key, 10, type: :bytes, json_name: "macaroonRootKey"
end

defmodule Lightnex.LNRPC.WalletUnlocker.InitWalletResponse do
  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :admin_macaroon, 1, type: :bytes, json_name: "adminMacaroon"
end

defmodule Lightnex.LNRPC.WalletUnlocker.WatchOnly do
  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
  ...
  field :accounts, 3, repeated: true, type: Lightnex.LNRPC.WalletUnlocker.WatchOnlyAccount
end

defmodule Lightnex.LNRPC.WalletUnlocker.WatchOnlyAccount do
  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
...
defmodule Lightnex.LNRPC.WalletUnlocker.UnlockWalletRequest do
  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
...
defmodule Lightnex.LNRPC.WalletUnlocker.UnlockWalletResponse do
  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
end

defmodule Lightnex.LNRPC.WalletUnlocker.ChangePasswordRequest do
  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
...
defmodule Lightnex.LNRPC.WalletUnlocker.ChangePasswordResponse do
  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :admin_macaroon, 1, type: :bytes, json_name: "adminMacaroon"
end

defmodule Lightnex.LNRPC.WalletUnlocker.Service do
  @moduledoc """
  ...
  rpc :GenSeed,
      Lightnex.LNRPC.WalletUnlocker.GenSeedRequest,
      Lightnex.LNRPC.WalletUnlocker.GenSeedResponse

  rpc :InitWallet,
      Lightnex.LNRPC.WalletUnlocker.InitWalletRequest,
      Lightnex.LNRPC.WalletUnlocker.InitWalletResponse

  rpc :UnlockWallet,
      Lightnex.LNRPC.WalletUnlocker.UnlockWalletRequest,
      Lightnex.LNRPC.WalletUnlocker.UnlockWalletResponse

  rpc :ChangePassword,
      Lightnex.LNRPC.WalletUnlocker.ChangePasswordRequest,
      Lightnex.LNRPC.WalletUnlocker.ChangePasswordResponse
end

defmodule Lightnex.LNRPC.WalletUnlocker.Stub do
  use GRPC.Stub, service: Lightnex.LNRPC.WalletUnlocker.Service
end
